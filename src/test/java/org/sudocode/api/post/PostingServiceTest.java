...
class PostingServiceTest {
    ...
    void updateProject_sameAuthor_thenUpdate() {
        ...
        final Project result = postingService.updateProject(
            originalId, Project.builder(user1)
                               .title("new title")
                               .description("new description")
                               .difficulty(EXPERT).build(), this.user1);
    ...
    void fetchLatestPostDateByAuthorId_noLastPost() {
        given(projectRepo.lastPostDateByUserId(any()))
            .willReturn(Optional.empty());
        given(commentRepo.lastPostDateByUserId(any()))
            .willReturn(Optional.empty());
    ...
    void fetchLatestDate_lastPostAvailable() {
        ...
        given(commentRepo.lastPostDateByUserId(1L))

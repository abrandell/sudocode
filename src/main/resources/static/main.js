...
/* harmony import */ var _shared_vote_vote_component__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! ./shared/vote/vote.component */ "./src/app/shared/vote/vote.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [
                ...
                _shared_vote_vote_component__WEBPACK_IMPORTED_MODULE_27__["VoteComponent"],
            ],
            imports: [
...
module.exports = "#comments {\n  font-family: \"Open Sans\", sans-serif;\n  font-size: 1rem;\n  padding-bottom: 5rem; }\n  #comments .comment-list-metadata {\n    display: grid;\n    grid-template-columns: repeat(3, auto); }\n  #comments .comment-list-metadata .result-amount {\n      justify-self: start; }\n  #comments .comment-list-metadata .sort-order {\n      margin: 0;\n      width: 6rem;\n      height: 1.3rem;\n      padding: 0;\n      justify-self: center; }\n  #comments .comment-list-metadata .pagination-sm {\n      display: flex;\n      justify-self: end; }\n  #comments .comment-post-form {\n    padding-top: 2rem; }\n  #comments .comment-list {\n    list-style-type: none;\n    padding: 0; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
module.exports = "#header .jumbotron {\n  background-color: transparent; }\n  #header .jumbotron h1 {\n    margin-left: 1rem;\n    margin-right: 1rem;\n    line-break: normal;\n    font-family: 'Helvetica Neue', sans-serif; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
module.exports = ".project-card-wrapper {\n  display: grid;\n  grid-template-columns: 2rem auto;\n  margin-top: 4rem; }\n  .project-card-wrapper #project-card {\n    border-radius: 5px; }\n  .project-card-wrapper #project-card .title {\n      color: #1c2331;\n      font-family: \"Montserrat\", sans-serif;\n      font-weight: 700;\n      font-size: 1.4rem; }\n  .project-card-wrapper #project-card .title:hover {\n        color: #639fab;\n        cursor: pointer; }\n  .project-card-wrapper #project-card #preview-content {\n      margin-top: 1rem;\n      margin-left: 1.2rem; }\n  .project-card-wrapper #project-card #preview-content #description {\n        font-size: 1rem;\n        line-height: 24px;\n        word-wrap: break-spaces;\n        white-space: pre-wrap;\n        padding-bottom: 2rem;\n        font-family: \"Open Sans\", sans-serif; }\n  .project-card-wrapper #project-card #preview-content .read-more {\n        align-self: center;\n        cursor: pointer;\n        font-size: 1rem;\n        font-weight: 500;\n        color: #3e505b;\n        padding-bottom: 1rem; }\n  .project-card-wrapper #project-card #preview-content .read-more:hover {\n          color: #639fab; }\n  .project-card-wrapper #project-card #metadata {\n      font-size: .9rem;\n      padding-top: .5rem;\n      display: grid;\n      grid-template-columns: repeat(2, auto); }\n  .project-card-wrapper #project-card #metadata .user-details {\n        justify-self: left; }\n  .project-card-wrapper #project-card #metadata .user-details .avatar {\n          max-height: 20px;\n          max-width: 20px;\n          box-shadow: 0 0 .1rem black;\n          border-radius: 50px; }\n  .project-card-wrapper #project-card #metadata .date {\n        justify-self: right; }\n  .project-card-wrapper #project-card #difficulty {\n      color: gray;\n      padding-bottom: 1rem; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
module.exports = "#details-container {\n  display: grid;\n  grid-template-columns: 2rem auto; }\n  #details-container app-vote {\n    margin-left: 5rem; }\n  .details-page {\n  max-width: 90%; }\n  .details-page #project-details #details-header {\n    padding-bottom: 1rem; }\n  .details-page #project-details #details-header .title {\n      font-family: \"Montserrat\", sans-serif;\n      font-weight: 600;\n      font-size: 1.5rem;\n      margin-bottom: 1rem; }\n  .details-page #project-details #details-header .difficulty {\n      padding-left: 1rem; }\n  .details-page #project-details #details-header .date {\n      justify-self: end;\n      font-size: .9rem;\n      float: right; }\n  .details-page #project-details .metadata {\n    margin: 0;\n    display: grid; }\n  .details-page #project-details .metadata .difficulty {\n      font-size: 1.2rem;\n      padding-left: 1rem;\n      color: gray;\n      font-family: \"Open Sans\", sans-serif; }\n  .details-page #project-details .metadata #user-info {\n      font-size: 1rem;\n      justify-self: start; }\n  .details-page #project-details .metadata #user-info .author-avatar img {\n        max-height: 20px;\n        max-width: 20px;\n        border-radius: 50px; }\n  .details-page #project-details .metadata #user-info .author-login {\n        padding-left: .3rem;\n        font-size: 1rem; }\n  .details-page #project-details .project-description {\n    margin-top: 1.5rem;\n    white-space: pre-wrap; }\n  .details-page #project-details .project-description .text {\n      font-family: \"Open Sans\", sans-serif;\n      font-size: 1rem;\n      word-wrap: break-spaces;\n      padding-bottom: 2rem; }\n  .details-page #project-details .author-buttons {\n    max-width: -webkit-fit-content;\n    max-width: -moz-fit-content;\n    max-width: fit-content;\n    float: right; }\n  .details-page #project-details .author-buttons #delete {\n      margin-left: .5rem; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
/***/ "./src/app/shared/vote/vote.component.html":
/*!*************************************************!*\
  !*** ./src/app/shared/vote/vote.component.html ***!
  \*************************************************/
/*! no static exports found */
...
module.exports = "<div class=\"container \" id=\"vote\">\n  <button [disabled]=\"!auth.authenticated\" id=\"upvote-btn\" (click)=\"upVote()\" class=\"vote-button fa fa-arrow-up\"></button>\n  <div id=\"upvote-count\">{{project?.rating}}</div>\n  <button [disabled]=\"!auth.authenticated\" id=\"downvote-btn\" (click)=\"downVote()\" class=\"vote-button fa fa-arrow-down\"></button>\n</div>\n"

/***/ }),

/***/ "./src/app/shared/vote/vote.component.scss":
/*!*************************************************!*\
  !*** ./src/app/shared/vote/vote.component.scss ***!
  \*************************************************/
/*! no static exports found */
...
module.exports = "#vote {\n  display: grid;\n  grid-template-rows: repeat(3, 2.25rem);\n  margin-top: .5rem;\n  color: lightgray;\n  justify-content: center;\n  font-size: 1.5rem; }\n  #vote .vote-button {\n    background-color: transparent;\n    border: none;\n    color: inherit;\n    outline: none; }\n  #vote .vote-button:not(:disabled) {\n      cursor: pointer; }\n  #vote .vote-button:not(:disabled):hover {\n        color: #639fab; }\n  #vote #upvote-count {\n    justify-self: center !important; }\n\n/*# sourceMappingURL=data:application/json;base64, */"

/***/ }),

/***/ "./src/app/shared/vote/vote.component.ts":
/*!***********************************************!*\
  !*** ./src/app/shared/vote/vote.component.ts ***!
  \***********************************************/
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _project_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../project.service */ "./src/app/shared/project.service.ts");
/* harmony import */ var _auth_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../auth.service */ "./src/app/shared/auth.service.ts");
/* harmony import */ var _vote_enum__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../vote.enum */ "./src/app/shared/vote.enum.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var VoteComponent = /** @class */ (function () {
    function VoteComponent(service, auth) {
        this.service = service;
        this.auth = auth;
        this.upvoted = false;
        this.downvoted = false;
    ...
    VoteComponent.prototype.upVote = function () {
        ...
        if (this.upvoted) {
            this.project.rating++;
            this.service.voteOnProject(_vote_enum__WEBPACK_IMPORTED_MODULE_3__["Vote"].UPVOTE, this.project.id);
        }
        else {
            this.unVote();
        }
    };
    VoteComponent.prototype.unVote = function () {
        this.service.voteOnProject(_vote_enum__WEBPACK_IMPORTED_MODULE_3__["Vote"].UNVOTE, this.project.id);
    };
    VoteComponent.prototype.downVote = function () {
        this.downvoted = !this.downvoted;
        if (this.downvoted) {
            this.project.rating--;
            this.service.voteOnProject(_vote_enum__WEBPACK_IMPORTED_MODULE_3__["Vote"].DOWNVOTE, this.project.id);
        }
        else {
            this.unVote();
        }
    ...
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Object)
    ], VoteComponent.prototype, "project", void 0);
    VoteComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-vote',
            template: __webpack_require__(/*! ./vote.component.html */ "./src/app/shared/vote/vote.component.html"),
            styles: [__webpack_require__(/*! ./vote.component.scss */ "./src/app/shared/vote/vote.component.scss")]
        }),
        __metadata("design:paramtypes", [_project_service__WEBPACK_IMPORTED_MODULE_1__["ProjectService"], _auth_service__WEBPACK_IMPORTED_MODULE_2__["AuthService"]])
    ], VoteComponent);
